...
def import_data(matrix_type="partial"):
    if matrix_type == "partial":
        ...
        path = os.path.join(DIR, '../data/expanded_item_item_cf/preprocessed_queries.csv')
    elif matrix_type == "user_item_weighted":
        path = os.path.join(DIR, '../data/expanded_item_item_cf/partial_users_items_utility_matrix.csv')
...
def preprocess_query(partial_utility_matrix_df,relational_data_df):
    ...
    csv_path= os.path.join(DIR, '../data/expanded_item_item_cf/preprocessed_queries.csv')
...
def create_relational_data_utility_matrix(partial_utility_matrix_df,preprocess_data_df):
    ...
    csv_path= os.path.join(DIR, '../data/expanded_item_item_cf/prova_csv_p.csv')
...
def create_relational_data_utility_matrix_weighted(partial_utility_matrix_df,preprocess_data_df):
    ...
    csv_path= os.path.join(DIR, '../data/expanded_item_item_cf/partial_users_items_utility_matrix.csv')
    relational_data_utility_matrix.to_csv(csv_path)
...
def create_utility_matrix_from_item_matrix(user_item_df,preprocess_data_df,partial_utility_matrix_df):
    ...
    path= os.path.join(DIR, '../data/expanded_item_item_cf/complete_utility_matrix.csv')
...
def print_data_to_html(utility_matrix_before_pp, partial_utility_matrix, centered_matrix, utility_matrix_complete, difference_utility_matrix):
    with open(os.path.join(DIR, '../data/expanded_item_item_cf/viz.html'), 'w') as f:
...
def plot_heatmap(utility_matrix, title, annot=True, n_rows=100, n_columns=100):
    ...
    # save the plot
    plt.savefig(os.path.join(DIR, '../data/expanded_item_item_cf/heatmap.png'))
    plt.show()
...
def save_top_k_items(partial_utility_matrix, utility_matrix_complete, top_k=10, n_users=10):
    path = '../data/expanded_item_item_cf/top_' + str(top_k) + '_items_n_' + str(n_users) + '_users.txt'
...
if __name__ == '__main__':
    ...
    path= os.path.join(DIR, '../data/expanded_item_item_cf/users_items_utility_matrix_complete.csv')
    ...
    print('--------------')
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), '--------------\n')
    print('Configuration: N_ITEMS =', N_ITEMS, ', N_USERS =', N_USERS)
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), 'Configuration: N_ITEMS = ' + str(N_ITEMS) + ', N_USERS = ' + str(N_USERS) + '\n')
    ...
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), 'Performance of the item-item collaborative filtering algorithm:\n')
    ...
    print('MAE: ', mae)
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), 'MAE: ' + str(mae) + '\n')
    ...
    print('RMSE :', rmse)
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), 'RMSE: ' + str(rmse) + '\n')

    mape = calculate_mape(real_utility_matrix_complete, utility_matrix_complete)
    print('MAPE :', mape)
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), 'MAPE: ' + str(mape) + '\n')

    mre = calculate_mre(real_utility_matrix_complete, utility_matrix_complete)
    print('MRE: ', mre)
    log_to_txt(os.path.join(DIR, '../data/expanded_item_item_cf/performance.txt'), 'MRE: ' + str(mre) + '\n')
