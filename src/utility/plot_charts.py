...
def plot_charts(path):
    ...
    # save the chart
    plt.savefig('../../data/expanded_item_item_cf/expanded_item_item_users.png', dpi=300)
...
if __name__ == "__main__":
    #plot_charts('../data/expanded_item_item_cf/performance.txt')
    alternative_plot_charts_topk('../../data/PART_A/df_jaccard_similarity.csv')
